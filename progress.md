...
| 2026-09-07T04:30 | Codex | DONE | `frontend/src/engine/MeshEngine.ts` | Added deterministic WebRTC offerer election using stable node IDs. A joining pair now creates one offer instead of concurrent offers, allowing its DataChannel to open and appear in the peer count. |
